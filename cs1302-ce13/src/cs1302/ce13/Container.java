 ...
 * is unset.
 *
 * @param T the type of the objects stored in the Container
 */
public class Container<T> {
    ...
    /** A reference to another {@code Container<T>}. */
    ...
    /**
     * Constructs a {@code Container<T>} with the {@code contents} property <i>set</i>
    ...
    public void set(T contents) {
        Utility.nullCheck("Container<T>: set", contents);
